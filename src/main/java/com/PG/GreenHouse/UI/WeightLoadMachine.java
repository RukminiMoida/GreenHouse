...
import com.PG.GreenHouse.Utils.UsbService;

import java.lang.ref.WeakReference;
import java.util.Set;

public class WeightLoadMachine extends AppCompatActivity {

    private UsbService usbService;
    private MyHandler mHandler;

    private TextView display,buttonSend;
...
//                    Toast.makeText(context, "No USB Found", Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weight_load_machine);
...
//                        mActivity.get().display.append(data);
                        Log.e("dataNew", "handleMessage if " + data);
                    } catch (Exception e) {
                        Log.e("dataNew", "handleMessage else " + e);
                    }
